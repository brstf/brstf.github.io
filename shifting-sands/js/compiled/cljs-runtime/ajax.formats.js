...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__48384){
...
var request = map__48385__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48385__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__48390 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__48390.cljs$core$IFn$_invoke$arity$1 ? fexpr__48390.cljs$core$IFn$_invoke$arity$1(response) : fexpr__48390.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__48391 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__48391.cljs$core$IFn$_invoke$arity$1 ? fexpr__48391.cljs$core$IFn$_invoke$arity$1(response) : fexpr__48391.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__48392){
...
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48393__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
