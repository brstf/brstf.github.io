...
}catch (e41483){var _e = e41483;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___41507 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___41507)){
var seen_errors_41508 = temp__5733__auto___41507;
if(cljs.core.truth_(seen_errors_41508.has(self))){
} else {
seen_errors_41508.add(self);

var temp__5735__auto___41509 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___41509)){
var sense_41511 = temp__5735__auto___41509;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_41511)].join(''));
} else {
}
}
} else {
