...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__53013_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__53013_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__53013_SHARP_) <= ending)));
}));
});
...
var G__53070 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
var G__53070__$1 = (((G__53070 instanceof cljs.core.Keyword))?G__53070.fqn:null);
switch (G__53070__$1) {
...
return ((cljs.core.not_any_QMARK_((function (p1__53079_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("sub","dispose","sub/dispose",365440536),p1__53079_SHARP_);
...
return cljs.core.assoc_in(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"operation","operation",-1267664310).cljs$core$IFn$_invoke$arity$1(trace),new cljs.core.Keyword(null,"layer","layer",-1601820589)], null),(cljs.core.truth_(cljs.core.some((function (p1__53116_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(app_db_id,p1__53116_SHARP_);
...
})),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__53130){
var vec__53131 = p__53130;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53131,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53131,(1),null);
...
var new_state = (function (){var G__53208 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
var G__53208__$1 = (((G__53208 instanceof cljs.core.Keyword))?G__53208.fqn:null);
switch (G__53208__$1) {
case "sub/create":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__53208__$1)].join('')));
...
var second_pass = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (all_state,p__53227){
var vec__53228 = p__53227;
var sub_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53228,(0),null);
var sub_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53228,(1),null);
