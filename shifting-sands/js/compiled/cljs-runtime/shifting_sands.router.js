...
shifting_sands.router.history = (function (){var dispatch = (function (p1__48608_SHARP_){
var G__48610 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("shifting-sands.events","set-active-page","shifting-sands.events/set-active-page",1700852759),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.Keyword(null,"handler","handler",-195596612).cljs$core$IFn$_invoke$arity$1(p1__48608_SHARP_)], null)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__48610) : re_frame.core.dispatch.call(null,G__48610));
});
var match = (function (p1__48609_SHARP_){
return bidi.bidi.match_route(shifting_sands.router.routes,p1__48609_SHARP_);
});
