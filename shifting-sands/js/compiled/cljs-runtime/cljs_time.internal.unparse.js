...
var periods__$1 = cljs.core.vec((function (){var G__63771 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__63770_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__63770_SHARP_,(0),(3));
}),G__63771);
} else {
return G__63771;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__63800){
var vec__63802 = p__63800;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63802,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63802,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__63805 = pattern;
switch (G__63805) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63805)].join('')));
...
switch (G__63814__$1) {
case "millis":
return (function (p1__63806_SHARP_){
return p1__63806_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__63807_SHARP_){
return p1__63807_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__63808_SHARP_){
return p1__63808_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__63809_SHARP_){
return p1__63809_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__63810_SHARP_){
return p1__63810_SHARP_.getHours();
});

break;
case "day":
return (function (p1__63811_SHARP_){
return p1__63811_SHARP_.getDate();
});

break;
case "month":
return (function (p1__63812_SHARP_){
return p1__63812_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__63813_SHARP_){
return p1__63813_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63814__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__63820){
var vec__63821 = p__63820;
var seq__63822 = cljs.core.seq(vec__63821);
var first__63823 = cljs.core.first(seq__63822);
var seq__63822__$1 = cljs.core.next(seq__63822);
var key = first__63823;
var args = seq__63822__$1;
var G__63824 = key;
...
break;
case "ordinal-suffix":
var vec__63825 = (function (){var G__63828 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__63828) : syntax_list.call(null,G__63828));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63825,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63824__$1)].join('')));
...
var d = value;
var G__63833 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__63834 = G__63833;
var seq__63835 = cljs.core.seq(vec__63834);
var first__63836 = cljs.core.first(seq__63835);
var seq__63835__$1 = cljs.core.next(seq__63835);
var unparser = first__63836;
var more = seq__63835__$1;
var s = "";
var d__$1 = d;
var G__63833__$1 = G__63833;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__63843 = G__63833__$1;
var seq__63844 = cljs.core.seq(vec__63843);
var first__63845 = cljs.core.first(seq__63844);
var seq__63844__$1 = cljs.core.next(seq__63844);
var unparser__$1 = first__63845;
var more__$1 = seq__63844__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__63846 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63846,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63846,(1),null);
var G__63887 = d__$3;
var G__63888 = more__$1;
var G__63889 = s__$3;
d__$1 = G__63887;
G__63833__$1 = G__63888;
s__$1 = G__63889;
continue;
}
break;
