...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__51753 = c;
var G__51753__$1 = (((G__51753 == null))?null:G__51753.prototype);
if((G__51753__$1 == null)){
return null;
} else {
return G__51753__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__51767 = c;
var G__51767__$1 = (((G__51767 == null))?null:G__51767.prototype);
if((G__51767__$1 == null)){
return null;
} else {
return G__51767__$1.render;
}
})() == null)))));
});
...
var G__51789 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__51789) : reagent.impl.component.as_element.call(null,G__51789));
};
...
var G__51796 = c;
var G__51796__$1 = (((G__51796 == null))?null:G__51796.constructor);
if((G__51796__$1 == null)){
return null;
} else {
return G__51796__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__51801 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__51802 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__51802);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__51801);
}});
...
var c = this;
var G__51909_51954 = goog.object.get(c,"cljsRatom");
if((G__51909_51954 == null)){
} else {
reagent.ratom.dispose_BANG_(G__51909_51954);
}
...
var renders_51955 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_51956 = cljs.core.first(cljs.core.vals(renders_51955));
...
if((cljs.core.count(renders_51955) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_51955))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_51956)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_51956], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__51917 = o;
goog.object.set(G__51917,cljs.core.name(k),v);
