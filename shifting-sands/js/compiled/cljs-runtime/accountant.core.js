...
if(cljs.core.truth_(((cljs.core.not(any_key))?(function (){var and__4115__auto__ = (function (){var fexpr__48092 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["",null,"_self",null], null), null);
return (fexpr__48092.cljs$core$IFn$_invoke$arity$1 ? fexpr__48092.cljs$core$IFn$_invoke$arity$1(link_target) : fexpr__48092.call(null,link_target));
})();
if(cljs.core.truth_(and__4115__auto__)){
 ...
 */
accountant.core.configure_navigation_BANG_ = (function accountant$core$configure_navigation_BANG_(p__48094){
...
var nav_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48095__$1,new cljs.core.Keyword(null,"nav-handler","nav-handler",2039495484));
var path_exists_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48095__$1,new cljs.core.Keyword(null,"path-exists?","path-exists?",1473384514));
var reload_same_path_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48095__$1,new cljs.core.Keyword(null,"reload-same-path?","reload-same-path?",1981904231));
...
var seq__48102 = cljs.core.seq(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [accountant.core.document_click_handler_listener_key,accountant.core.navigate_listener_key], null));
var chunk__48103 = null;
var count__48104 = (0);
var i__48105 = (0);
while(true){
if((i__48105 < count__48104)){
var key = chunk__48103.cljs$core$IIndexed$_nth$arity$2(null,i__48105);
...
var G__48121 = seq__48102;
var G__48122 = chunk__48103;
var G__48123 = count__48104;
var G__48124 = (i__48105 + (1));
seq__48102 = G__48121;
chunk__48103 = G__48122;
count__48104 = G__48123;
i__48105 = G__48124;
continue;
} else {
...
var c__4556__auto__ = cljs.core.chunk_first(seq__48102__$1);
var G__48125 = cljs.core.chunk_rest(seq__48102__$1);
var G__48126 = c__4556__auto__;
var G__48127 = cljs.core.count(c__4556__auto__);
var G__48128 = (0);
seq__48102 = G__48125;
chunk__48103 = G__48126;
count__48104 = G__48127;
i__48105 = G__48128;
continue;
} else {
var key = cljs.core.first(seq__48102__$1);
if(cljs.core.truth_(key)){
goog.events.unlistenByKey(key);
} else {
}
...
var G__48130 = cljs.core.next(seq__48102__$1);
var G__48131 = null;
var G__48132 = (0);
var G__48133 = (0);
seq__48102 = G__48130;
...
var params = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48107_SHARP_){
return cljs.core.name(p1__48107_SHARP_);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("&",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48108_SHARP_){
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("=",p1__48108_SHARP_);
}),pairs));
});
/**
...
if(cljs.core.truth_(accountant.core.nav_handler)){
var G__48115 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(query),cljs.core.str.cljs$core$IFn$_invoke$arity$1(hash)].join('');
return (accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1 ? accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1(G__48115) : accountant.core.nav_handler.call(null,G__48115));
} else {
