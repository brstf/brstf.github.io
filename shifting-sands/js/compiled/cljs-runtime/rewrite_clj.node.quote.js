...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k48949,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k48949,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__48955){
var vec__48959 = p__48955;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48959,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48959,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__48948){
var self__ = this;
var G__48948__$1 = this;
return (new cljs.core.RecordIter((0),G__48948__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this48950,other48951){
var self__ = this;
var this48950__$1 = this;
return (((!((other48951 == null)))) && ((this48950__$1.constructor === other48951.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48950__$1.tag,other48951.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48950__$1.prefix,other48951.prefix)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48950__$1.sym,other48951.sym)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48950__$1.children,other48951.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48950__$1.__extmap,other48951.__extmap)));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__48948){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__48971 = cljs.core.keyword_identical_QMARK_;
var expr__48972 = k__4388__auto__;
if(cljs.core.truth_((pred__48971.cljs$core$IFn$_invoke$arity$2 ? pred__48971.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__48972) : pred__48971.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__48972)))){
return (new rewrite_clj.node.quote.QuoteNode(G__48948,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__48971.cljs$core$IFn$_invoke$arity$2 ? pred__48971.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__48972) : pred__48971.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__48972)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__48948,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__48971.cljs$core$IFn$_invoke$arity$2 ? pred__48971.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__48972) : pred__48971.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__48972)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__48948,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__48971.cljs$core$IFn$_invoke$arity$2 ? pred__48971.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__48972) : pred__48971.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__48972)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__48948,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__48948),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__48948){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__48948,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__48952){
var extmap__4419__auto__ = (function (){var G__48979 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__48952,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__48952)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__48979);
} else {
return G__48979;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__48952),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__48952),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__48952),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__48952),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var G__49023 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__49023;
continue;
}
break;
...
var G__49032 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__49032;
continue;
}
break;
