...
var vec__52264 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__52268 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52268,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52268,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52264,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52264,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__52280){
var vec__52289 = p__52280;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52289,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52289,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52296,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52296,(1),null);
...
var vec__52317 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52317,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52317,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52317,(2),null);
var vec__52320 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52320,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52320,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52320,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__52334){
var vec__52335 = p__52334;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52335,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52335,(1),null);
...
var vec__52341 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52341,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52341,(1),null);
...
var G__52344 = zprint.core.parse_string_all_options(rest_options);
var G__52345 = zprint.core.zprint_str_internal;
var G__52346 = ":parse-string-all? call";
var G__52347 = (function (){var G__52348 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__52348) : zprint.zutil.edn_STAR_.call(null,G__52348));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__52344,G__52345,G__52346,G__52347) : zprint.core.process_multiple_forms.call(null,G__52344,G__52345,G__52346,G__52347));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__52349 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52349,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52349,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq52338){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52339,G__52340,seq52338__$2);
}));
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq52354){
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq52356){
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq52359){
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq52368){
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__52385,form){
var vec__52386 = p__52385;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52386,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52386,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52386,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52386,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__52389 = (cljs.core.truth_((function (){var and__4115__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4115__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52389,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52389,(1),null);
...
var forms = (function (){var G__52448 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__52448) : zprint.zutil.edn_STAR_.call(null,G__52448));
})();
