...
var G__52377 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var or__4126__auto__ = route_change_event;
...
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__52377) : re_frame.core.dispatch.call(null,G__52377));
} else {
...
var vec__52385 = route;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52385,(0),null);
var path_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52385,(1),null);
...
var vec__52389 = clojure.string.split.cljs$core$IFn$_invoke$arity$3(clojure.string.replace(url,/^\/#\//,"/"),/#/,(2));
var path_PLUS_query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52389,(0),null);
var fragment = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52389,(1),null);
var vec__52392 = clojure.string.split.cljs$core$IFn$_invoke$arity$3(path_PLUS_query,/\?/,(2));
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52392,(0),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52392,(1),null);
var G__52395 = reitit.core.match_by_path(routes,path);
if((G__52395 == null)){
return null;
} else {
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__52395,new cljs.core.Keyword(null,"query-string","query-string",-1018845061),query,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"hash","hash",-13781596),fragment], 0));
}
});
...
(kee_frame.router.ReititRouter.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k52398,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k52398,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__52403){
var vec__52404 = p__52403;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52404,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52404,(1),null);
...
(kee_frame.router.ReititRouter.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this52399,other52400){
var self__ = this;
var this52399__$1 = this;
return (((!((other52400 == null)))) && ((this52399__$1.constructor === other52400.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52399__$1.routes,other52400.routes)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52399__$1.hash_QMARK_,other52400.hash_QMARK_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52399__$1.not_found,other52400.not_found)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52399__$1.__extmap,other52400.__extmap)));
}));
...
var or__4126__auto____$1 = (function (){var G__52408 = self__.not_found;
if((G__52408 == null)){
return null;
} else {
return kee_frame.router.match_url(self__.routes,G__52408);
}
})();
...
(kee_frame.router.ReititRouter.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__52397){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__52410 = cljs.core.keyword_identical_QMARK_;
var expr__52411 = k__4388__auto__;
if(cljs.core.truth_((pred__52410.cljs$core$IFn$_invoke$arity$2 ? pred__52410.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"routes","routes",457900162),expr__52411) : pred__52410.call(null,new cljs.core.Keyword(null,"routes","routes",457900162),expr__52411)))){
return (new kee_frame.router.ReititRouter(G__52397,self__.hash_QMARK_,self__.not_found,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__52410.cljs$core$IFn$_invoke$arity$2 ? pred__52410.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"hash?","hash?",-1899275922),expr__52411) : pred__52410.call(null,new cljs.core.Keyword(null,"hash?","hash?",-1899275922),expr__52411)))){
return (new kee_frame.router.ReititRouter(self__.routes,G__52397,self__.not_found,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__52410.cljs$core$IFn$_invoke$arity$2 ? pred__52410.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"not-found","not-found",-629079980),expr__52411) : pred__52410.call(null,new cljs.core.Keyword(null,"not-found","not-found",-629079980),expr__52411)))){
return (new kee_frame.router.ReititRouter(self__.routes,self__.hash_QMARK_,G__52397,self__.__meta,self__.__extmap,null));
} else {
return (new kee_frame.router.ReititRouter(self__.routes,self__.hash_QMARK_,self__.not_found,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__52397),null));
}
}
}
}));
...
(kee_frame.router.ReititRouter.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__52397){
var self__ = this;
var this__4379__auto____$1 = this;
return (new kee_frame.router.ReititRouter(self__.routes,self__.hash_QMARK_,self__.not_found,G__52397,self__.__extmap,self__.__hash));
}));
 ...
 */
kee_frame.router.map__GT_ReititRouter = (function kee_frame$router$map__GT_ReititRouter(G__52401){
var extmap__4419__auto__ = (function (){var G__52413 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__52401,new cljs.core.Keyword(null,"routes","routes",457900162),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"hash?","hash?",-1899275922),new cljs.core.Keyword(null,"not-found","not-found",-629079980)], 0));
if(cljs.core.record_QMARK_(G__52401)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__52413);
} else {
return G__52413;
}
})();
return (new kee_frame.router.ReititRouter(new cljs.core.Keyword(null,"routes","routes",457900162).cljs$core$IFn$_invoke$arity$1(G__52401),new cljs.core.Keyword(null,"hash?","hash?",-1899275922).cljs$core$IFn$_invoke$arity$1(G__52401),new cljs.core.Keyword(null,"not-found","not-found",-629079980).cljs$core$IFn$_invoke$arity$1(G__52401),null,cljs.core.not_empty(extmap__4419__auto__),null));
});

kee_frame.router.bootstrap_routes = (function kee_frame$router$bootstrap_routes(p__52415){
...
var routes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52416__$1,new cljs.core.Keyword(null,"routes","routes",457900162));
var router = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52416__$1,new cljs.core.Keyword(null,"router","router",1091916230));
var hash_routing_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52416__$1,new cljs.core.Keyword(null,"hash-routing?","hash-routing?",471914732));
var scroll = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52416__$1,new cljs.core.Keyword(null,"scroll","scroll",971553779));
var route_change_event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52416__$1,new cljs.core.Keyword(null,"route-change-event","route-change-event",1834214120));
var not_found = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52416__$1,new cljs.core.Keyword(null,"not-found","not-found",-629079980));
...
var map__52422 = cljs.core.deref(kee_frame.state.debug_config);
...
var routes_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52422__$1,new cljs.core.Keyword(null,"routes?","routes?",-1257506224),true);
...
return re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("kee-frame.router","route-changed","kee-frame.router/route-changed",8744849),(cljs.core.truth_(kee_frame.router.debug_enabled_QMARK_())?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.core.debug], null):null),(function (p__52425,p__52426){
var map__52427 = p__52425;
...
var ctx = map__52427__$1;
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52427__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__52428 = p__52426;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52428,(0),null);
var route = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52428,(1),null);
if(cljs.core.truth_(scroll)){
...
kee_frame.router.start_BANG_ = (function kee_frame$router$start_BANG_(p__52434){
...
var config = map__52435__$1;
var initial_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52435__$1,new cljs.core.Keyword(null,"initial-db","initial-db",1939835102));
var debug_config = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52435__$1,new cljs.core.Keyword(null,"debug-config","debug-config",329260673));
var routes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52435__$1,new cljs.core.Keyword(null,"routes","routes",457900162));
var screen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52435__$1,new cljs.core.Keyword(null,"screen","screen",1990059748));
var router = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52435__$1,new cljs.core.Keyword(null,"router","router",1091916230));
var app_db_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52435__$1,new cljs.core.Keyword(null,"app-db-spec","app-db-spec",-1030582586));
var chain_links = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52435__$1,new cljs.core.Keyword(null,"chain-links","chain-links",951542256));
var debug_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52435__$1,new cljs.core.Keyword(null,"debug?","debug?",-1831756173),false);
var scroll = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52435__$1,new cljs.core.Keyword(null,"scroll","scroll",971553779),true);
var root_component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52435__$1,new cljs.core.Keyword(null,"root-component","root-component",-1807026475));
...
var G__52437_52482 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"init","init",-1875481434),initial_db], null);
(re_frame.core.dispatch_sync.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch_sync.cljs$core$IFn$_invoke$arity$1(G__52437_52482) : re_frame.core.dispatch_sync.call(null,G__52437_52482));
} else {
}

if(cljs.core.truth_(screen)){
var config_52483__$1 = ((cljs.core.boolean_QMARK_(screen))?null:screen);
if(cljs.core.truth_(cljs.core.deref(kee_frame.state.breakpoints_initialized_QMARK_))){
kee_frame.interop.set_breakpoint_subs(config_52483__$1);
} else {
kee_frame.interop.set_breakpoints(config_52483__$1);
...
var G__52438_52484 = new cljs.core.Keyword("kee-frame","route","kee-frame/route",-106555640);
var G__52439_52485 = (function (db){
return new cljs.core.Keyword("kee-frame","route","kee-frame/route",-106555640).cljs$core$IFn$_invoke$arity$2(db,null);
});
(re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2(G__52438_52484,G__52439_52485) : re_frame.core.reg_sub.call(null,G__52438_52484,G__52439_52485));
...
var route = (function (){var G__52442 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("kee-frame","route","kee-frame/route",-106555640)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__52442) : re_frame.core.subscribe.call(null,G__52442));
})();
var dispatch_value = (function (){var G__52443 = cljs.core.deref(route);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__52443) : f.call(null,G__52443));
})();
var G__52447 = cljs.core.partition.cljs$core$IFn$_invoke$arity$2((2),pairs);
var vec__52448 = G__52447;
...
var first_pair = first__52450;
var rest_pairs = seq__52449__$1;
var G__52447__$1 = G__52447;
while(true){
var vec__52451 = G__52447__$1;
...
var first_pair__$1 = first__52453;
var rest_pairs__$1 = seq__52452__$1;
if(cljs.core.truth_(first_pair__$1)){
var vec__52454 = first_pair__$1;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52454,(0),null);
var component = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52454,(1),null);
...
var G__52499 = rest_pairs__$1;
G__52447__$1 = G__52499;
continue;
}
} else {
...
/** @this {Function} */
(kee_frame.router.switch_route.cljs$lang$applyTo = (function (seq52440){
