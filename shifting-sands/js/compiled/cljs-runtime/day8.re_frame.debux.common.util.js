...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__62493){
var vec__62494 = p__62493;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62494,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62494,(1),null);
...
return clojure.zip.zipper((function (p1__62497_SHARP_){
return ((cljs.core.sequential_QMARK_(p1__62497_SHARP_)) || (cljs.core.map_QMARK_(p1__62497_SHARP_)));
}),(function (x){
...
if(cljs.core.map_QMARK_(x)){
return cljs.core.with_meta(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__62501){
var vec__62502 = p__62501;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62502,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62502,(1),null);
...
day8.re_frame.debux.common.util.named_gensym_pattern = /(.*?)\d{4,}/;
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__62508_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__62508_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62507_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__62507_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__62510_SHARP_){
return (((p1__62510_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__62510_SHARP_) == null)));
 ...
 */
day8.re_frame.debux.common.util.with_symbols_names = (function day8$re_frame$debux$common$util$with_symbols_names(form,p__62514,mapping){
...
var state = map__62515__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62515__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62515__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62515__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__62512_SHARP_){
if((p1__62512_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__62512_SHARP_);
} else {
return false;
}
}),day8.re_frame.debux.common.util.form_tree_seq(form)));
...
var G__62630 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__62633 = clojure.zip.next(loc);
loc = G__62633;
continue;
}
}
...
(day8.re_frame.debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__62537){
var vec__62538 = p__62537;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62538,(0),null);
...
/** @this {Function} */
(day8.re_frame.debux.common.util.form_header.cljs$lang$applyTo = (function (seq62533){
var G__62534 = cljs.core.first(seq62533);
var seq62533__$1 = cljs.core.next(seq62533);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__62534,seq62533__$1);
}));

day8.re_frame.debux.common.util.prepend_blanks = (function day8$re_frame$debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__62546_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__62546_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__62563_62651 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__62564_62652 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__62565_62653 = true;
var _STAR_print_fn_STAR__temp_val__62566_62654 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__62565_62653);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__62566_62654);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__62564_62652);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__62563_62651);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__62548_SHARP_){
return day8.re_frame.debux.common.util.prepend_bars(p1__62548_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__62659 = cljs.core.next(opts__$1);
var G__62660 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__62659;
acc = G__62660;
continue;
} else {
if(typeof f === 'string'){
var G__62661 = cljs.core.next(opts__$1);
var G__62662 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__62661;
acc = G__62662;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__62663 = cljs.core.nnext(opts__$1);
var G__62664 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__62663;
acc = G__62664;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__62665 = cljs.core.next(opts__$1);
var G__62666 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__62665;
acc = G__62666;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__62583 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__62583.cljs$core$IFn$_invoke$arity$1 ? fexpr__62583.cljs$core$IFn$_invoke$arity$1(f) : fexpr__62583.call(null,f));
})())){
var G__62667 = cljs.core.next(opts__$1);
var G__62668 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__62667;
acc = G__62668;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__62584 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__62584.cljs$core$IFn$_invoke$arity$1 ? fexpr__62584.cljs$core$IFn$_invoke$arity$1(f) : fexpr__62584.call(null,f));
})())){
var G__62669 = cljs.core.nnext(opts__$1);
var G__62670 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__62669;
acc = G__62670;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__62671 = cljs.core.next(opts__$1);
var G__62672 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__62671;
acc = G__62672;
continue;
} else {
...
day8.re_frame.debux.common.util.quote_val = (function day8$re_frame$debux$common$util$quote_val(p__62585){
var vec__62586 = p__62585;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62586,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62586,(1),null);
...
var G__62592 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__62591 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__62599 = quoted_form;
var G__62600 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__62599,G__62600) : day8.re_frame.debux.common.util.remove_d.call(null,G__62599,G__62600));
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__62604 = quoted_form;
var G__62605 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__62604,G__62605) : day8.re_frame.debux.common.util.remove_d.call(null,G__62604,G__62605));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__62677__delegate = function (arg){
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__62606 = quoted_form;
var G__62607 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__62606,G__62607) : day8.re_frame.debux.common.util.remove_d.call(null,G__62606,G__62607));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__62681__i < G__62681__a.length) {G__62681__a[G__62681__i] = arguments[G__62681__i + 0]; ++G__62681__i;}
  arg = new cljs.core.IndexedSeq(G__62681__a,0,null);
} 
return G__62677__delegate.call(this,arg);};
G__62677.cljs$lang$maxFixedArity = 0;
G__62677.cljs$lang$applyTo = (function (arglist__62682){
var arg = cljs.core.seq(arglist__62682);
return G__62677__delegate(arg);
});
...
day8.re_frame.debux.common.util.third = (function day8$re_frame$debux$common$util$third(coll){
...
var G__62687 = clojure.zip.replace(loc,day8.re_frame.debux.common.util.third(node));
loc = G__62687;
continue;
} else {
...
var G__62688 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__62688;
continue;
} else {
var G__62689 = clojure.zip.next(loc);
loc = G__62689;
continue;
