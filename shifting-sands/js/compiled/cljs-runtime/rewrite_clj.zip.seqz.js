...
var G__50160 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__50160__$1 = (((G__50160 == null))?null:cljs.core.iterate((function (loc){
...
var G__50160__$2 = (((G__50160__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__50160__$1));
var G__50160__$3 = (((G__50160__$2 == null))?null:cljs.core.last(G__50160__$2));
if((G__50160__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__50160__$3);
}
} else {
return zloc;
}
...
var G__50176 = rewrite_clj.zip.move.right(v);
var G__50177 = rewrite_clj.zip.move.up(v);
loc = G__50176;
parent = G__50177;
continue;
} else {
var G__50178 = rewrite_clj.zip.move.right(v0);
var G__50179 = parent;
loc = G__50178;
parent = G__50179;
continue;
...
var G__50180 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__50181 = rewrite_clj.zip.move.up(v);
loc = G__50180;
parent = G__50181;
continue;
} else {
var G__50182 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__50183 = parent;
loc = G__50182;
parent = G__50183;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__50172 = zloc;
var G__50172__$1 = (((G__50172 == null))?null:rewrite_clj.zip.move.down(G__50172));
var G__50172__$2 = (((G__50172__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__50172__$1,k));
if((G__50172__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__50172__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__50173 = rewrite_clj.zip.move.down(zloc);
var G__50173__$1 = (((G__50173 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__50173));
if((G__50173__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__50173__$1);
}
})(),k);
}
});
