...
var G__51969 = o;
goog.object.set(G__51969,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__52042__i < G__52042__a.length) {G__52042__a[G__52042__i] = arguments[G__52042__i + 0]; ++G__52042__i;}
  args = new cljs.core.IndexedSeq(G__52042__a,0,null);
} 
...
var G__51973 = o;
goog.object.set(G__51973,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__52048__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__52048 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__52049__i = 0, G__52049__a = new Array(arguments.length -  0);
while (G__52049__i < G__52049__a.length) {G__52049__a[G__52049__i] = arguments[G__52049__i + 0]; ++G__52049__i;}
  args = new cljs.core.IndexedSeq(G__52049__a,0,null);
} 
return G__52048__delegate.call(this,args);};
G__52048.cljs$lang$maxFixedArity = 0;
G__52048.cljs$lang$applyTo = (function (arglist__52050){
var args = cljs.core.seq(arglist__52050);
return G__52048__delegate(args);
});
...
var G__51980 = props;
var G__51980__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51980,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__51980);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51980__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__51980__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__51981 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51981,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__51981;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__51991){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51992__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__51998_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__51998_SHARP_);
}));
} else {
return null;
}
...
var vec__52007 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52007,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52007,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52007,(2),null);
...
var temp__5739__auto___52065 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___52065 == null)){
} else {
var key_52066 = temp__5739__auto___52065;
(jsprops.key = key_52066);
}
...
var temp__5739__auto___52067 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___52067 == null)){
} else {
var key_52068 = temp__5739__auto___52067;
(jsprops.key = key_52068);
}
...
var G__52018 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__52018) : reagent.impl.template.as_element.call(null,G__52018));
} else {
var temp__5739__auto___52073 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___52073 == null)){
} else {
var key_52074 = temp__5739__auto___52073;
(jsprops.key = key_52074);
}
...
var G__52020 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__52020)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__52020)){
return x;
} else {
...
var len__4736__auto___52075 = arguments.length;
var i__4737__auto___52076 = (0);
while(true){
if((i__4737__auto___52076 < len__4736__auto___52075)){
args__4742__auto__.push((arguments[i__4737__auto___52076]));

var G__52077 = (i__4737__auto___52076 + (1));
i__4737__auto___52076 = G__52077;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq52021){
var G__52022 = cljs.core.first(seq52021);
var seq52021__$1 = cljs.core.next(seq52021);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52022,seq52021__$1);
}));
...
break;
default:
var G__52082 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__52082;
continue;
...
var ctx = ({});
var vec__52036 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52036,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52036,(1),null);
...
var G__52039 = (cljs.core.count(argv) - first_child);
switch (G__52039) {
case (0):
