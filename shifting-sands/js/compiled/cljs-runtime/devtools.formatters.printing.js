...
var len__4736__auto___42274 = arguments.length;
var i__4737__auto___42275 = (0);
while(true){
if((i__4737__auto___42275 < len__4736__auto___42274)){
args__4742__auto__.push((arguments[i__4737__auto___42275]));

var G__42276 = (i__4737__auto___42275 + (1));
i__4737__auto___42275 = G__42276;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42211){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42212,G__42213,seq42211__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42221_SHARP_){
return (!((cljs.core.meta(p1__42221_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42234__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42248){var _e__41331__auto__ = e42248;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e42252){var _e__41331__auto__ = e42252;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42257 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42258 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42258);

try{var map__42259 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42259__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42257);
}});
...
var temp__5733__auto___42298 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___42298)){
var managed_print_level_42299 = temp__5733__auto___42298;
var _STAR_print_level_STAR__orig_val__42268_42301 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42269_42302 = managed_print_level_42299;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42269_42302);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42267_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42267_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42268_42301);
}} else {
job_fn();
}
