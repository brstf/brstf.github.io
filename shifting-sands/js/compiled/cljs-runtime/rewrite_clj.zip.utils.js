...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__49982,k,f){
var vec__49983 = p__49982;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49983,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49983,(1),null);
var loc = vec__49983;
...
var G__50081 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__50081;
continue;
}
break;
...
var G__50087 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__50087;
continue;
} else {
return zloc__$1;
...
var G__50108 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__50108;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__50007){
...
var path = map__50013__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50013__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__50010;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__50019){
var vec__50020 = p__50019;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50020,(0),null);
...
var path = map__50023__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50023__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__50020;
if(cljs.core.seq(r)){
...
var vec__50028 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50028,(0),null);
var map__50031 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50028,(1),null);
...
var path = map__50031__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50031__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50031__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50031__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50031__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
