...
var G__64358 = (i__4737__auto___64357 + (1));
i__4737__auto___64357 = G__64358;
continue;
} else {
}
break;
...
(re_com.splits.h_split.cljs$core$IFn$_invoke$arity$variadic = (function (p__64196){
...
var args = map__64197__$1;
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__64197__$1,new cljs.core.Keyword(null,"size","size",1098693007),"auto");
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64197__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64197__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64197__$1,new cljs.core.Keyword(null,"on-split-change","on-split-change",-1635241917));
var initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__64197__$1,new cljs.core.Keyword(null,"initial-split","initial-split",2072601727),(50));
var splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__64197__$1,new cljs.core.Keyword(null,"splitter-size","splitter-size",245247616),"8px");
var margin = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__64197__$1,new cljs.core.Keyword(null,"margin","margin",-995903681),"8px");
...
var G__64203_64359 = cljs.core.deref(split_perc);
(on_split_change.cljs$core$IFn$_invoke$arity$1 ? on_split_change.cljs$core$IFn$_invoke$arity$1(G__64203_64359) : on_split_change.call(null,G__64203_64359));
} else {
}
...
var _LT_html_GT__QMARK_ = (function (p1__64180_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__64180_SHARP_,document.documentElement);
});
...
return (function() { 
var G__64367__delegate = function (p__64241){
...
var _splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64242__$1,new cljs.core.Keyword(null,"_splitter-size","_splitter-size",-2092162822));
var panel_2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64242__$1,new cljs.core.Keyword(null,"panel-2","panel-2",244198907));
var panel_1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64242__$1,new cljs.core.Keyword(null,"panel-1","panel-1",998274139));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64242__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var _margin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64242__$1,new cljs.core.Keyword(null,"_margin","_margin",1508241828));
var _on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64242__$1,new cljs.core.Keyword(null,"_on-split-change","_on-split-change",1230437286));
var _width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64242__$1,new cljs.core.Keyword(null,"_width","_width",-75982426));
var _size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64242__$1,new cljs.core.Keyword(null,"_size","_size",-746489012));
var _height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64242__$1,new cljs.core.Keyword(null,"_height","_height",133867120));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64242__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var _initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64242__$1,new cljs.core.Keyword(null,"_initial-split","_initial-split",2145793073));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64242__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__64367 = function (var_args){
var p__64241 = null;
if (arguments.length > 0) {
var G__64372__i = 0, G__64372__a = new Array(arguments.length -  0);
while (G__64372__i < G__64372__a.length) {G__64372__a[G__64372__i] = arguments[G__64372__i + 0]; ++G__64372__i;}
  p__64241 = new cljs.core.IndexedSeq(G__64372__a,0,null);
} 
return G__64367__delegate.call(this,p__64241);};
G__64367.cljs$lang$maxFixedArity = 0;
G__64367.cljs$lang$applyTo = (function (arglist__64373){
var p__64241 = cljs.core.seq(arglist__64373);
return G__64367__delegate(p__64241);
});
G__64367.cljs$core$IFn$_invoke$arity$variadic = G__64367__delegate;
return G__64367;
})()
;
}));
...
/** @this {Function} */
(re_com.splits.h_split.cljs$lang$applyTo = (function (seq64185){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq64185));
}));
...
var args__4742__auto__ = [];
var len__4736__auto___64374 = arguments.length;
var i__4737__auto___64375 = (0);
while(true){
if((i__4737__auto___64375 < len__4736__auto___64374)){
args__4742__auto__.push((arguments[i__4737__auto___64375]));

var G__64376 = (i__4737__auto___64375 + (1));
i__4737__auto___64375 = G__64376;
continue;
} else {
}
break;
...
(re_com.splits.v_split.cljs$core$IFn$_invoke$arity$variadic = (function (p__64250){
var map__64252 = p__64250;
...
var args = map__64252__$1;
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__64252__$1,new cljs.core.Keyword(null,"size","size",1098693007),"auto");
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64252__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64252__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64252__$1,new cljs.core.Keyword(null,"on-split-change","on-split-change",-1635241917));
var initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__64252__$1,new cljs.core.Keyword(null,"initial-split","initial-split",2072601727),(50));
var splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__64252__$1,new cljs.core.Keyword(null,"splitter-size","splitter-size",245247616),"8px");
var margin = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__64252__$1,new cljs.core.Keyword(null,"margin","margin",-995903681),"8px");
...
var stop_drag = (function (){
if(cljs.core.truth_(on_split_change)){
var G__64255_64379 = cljs.core.deref(split_perc);
(on_split_change.cljs$core$IFn$_invoke$arity$1 ? on_split_change.cljs$core$IFn$_invoke$arity$1(G__64255_64379) : on_split_change.call(null,G__64255_64379));
} else {
}
...
var _LT_html_GT__QMARK_ = (function (p1__64247_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__64247_SHARP_,document.documentElement);
});
var mouseout = (function (event){
if(_LT_html_GT__QMARK_(event.relatedTarget)){
return stop_drag();
...
return (function() { 
var G__64437__delegate = function (p__64288){
var map__64289 = p__64288;
var map__64289__$1 = (((((!((map__64289 == null))))?(((((map__64289.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__64289.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__64289):map__64289);
var _splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64289__$1,new cljs.core.Keyword(null,"_splitter-size","_splitter-size",-2092162822));
var panel_2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64289__$1,new cljs.core.Keyword(null,"panel-2","panel-2",244198907));
var panel_1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64289__$1,new cljs.core.Keyword(null,"panel-1","panel-1",998274139));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64289__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var _margin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64289__$1,new cljs.core.Keyword(null,"_margin","_margin",1508241828));
var _on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64289__$1,new cljs.core.Keyword(null,"_on-split-change","_on-split-change",1230437286));
var _width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64289__$1,new cljs.core.Keyword(null,"_width","_width",-75982426));
var _size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64289__$1,new cljs.core.Keyword(null,"_size","_size",-746489012));
var _height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64289__$1,new cljs.core.Keyword(null,"_height","_height",133867120));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64289__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var _initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64289__$1,new cljs.core.Keyword(null,"_initial-split","_initial-split",2145793073));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64289__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__64437 = function (var_args){
var p__64288 = null;
if (arguments.length > 0) {
...
while (G__64458__i < G__64458__a.length) {G__64458__a[G__64458__i] = arguments[G__64458__i + 0]; ++G__64458__i;}
  p__64288 = new cljs.core.IndexedSeq(G__64458__a,0,null);
} 
return G__64437__delegate.call(this,p__64288);};
G__64437.cljs$lang$maxFixedArity = 0;
G__64437.cljs$lang$applyTo = (function (arglist__64459){
var p__64288 = cljs.core.seq(arglist__64459);
return G__64437__delegate(p__64288);
});
G__64437.cljs$core$IFn$_invoke$arity$variadic = G__64437__delegate;
return G__64437;
})()
;
}));
...
/** @this {Function} */
(re_com.splits.v_split.cljs$lang$applyTo = (function (seq64249){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq64249));
}));
