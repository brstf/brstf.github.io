...
var G__42034 = devtools.prefs.pref(v);
v = G__42034;
continue;
} else {
return v;
...
}catch (e41922){var _e__41331__auto__ = e41922;
return false;
}})();
...
}catch (e41928){var _e__41331__auto__ = e41928;
return false;
}})();
...
}catch (e41930){var _e__41331__auto__ = e41930;
return false;
}}
}
});
...
var vec__41975 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41975,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41975,(1),null);
...
return cljs.core.some((function (p1__41989_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41989_SHARP_);
}),template);
});
