...
if((c === "\n")){
var G__49603 = escape_QMARK_;
var G__49604 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__49603;
lines = G__49604;
continue;
} else {
buf.append(c);

var G__49605 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__49606 = lines;
escape_QMARK_ = G__49605;
lines = G__49606;
continue;
...
var G__49599 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__49599) : rewrite_clj.node.string_node.call(null,G__49599));
});
...
var G__49601 = cljs.core.re_pattern(regex);
var G__49602 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__49601,G__49602) : rewrite_clj.node.token_node.call(null,G__49601,G__49602));
});
