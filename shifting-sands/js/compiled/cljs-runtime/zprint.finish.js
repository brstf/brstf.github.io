...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__48694_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__48694_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__48694_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__48708){
var vec__48709 = p__48708;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48709,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48709,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__48717,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48718__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48718__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48718__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__48724 = (function (){var or__4126__auto__ = color;
...
var fexpr__48723 = (function (){var G__48727 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__48727) : style_map.call(null,G__48727));
})();
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__48729){
var vec__48730 = p__48729;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48730,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48730,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48730,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__48739){
var vec__48740 = p__48739;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48740,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48740,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48740,(2),null);
...
var G__48834 = cljs.core.next(ssv);
var G__48835 = (this_ssv == null);
var G__48836 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__48837 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__48834;
doing_nil_QMARK_ = G__48835;
last_elide = G__48836;
out = G__48837;
continue;
}
...
var vec__48765 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48765,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48765,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48765,(2),null);
...
var G__48839 = cljs.core.next(remaining_cvec);
var G__48840 = new_idx;
var G__48841 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__48839;
idx = G__48840;
out = G__48841;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__48778,cursor_vec){
var vec__48779 = p__48778;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48779,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48779,(1),null);
var focus_vec = vec__48779;
...
var vec__48782 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48782,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48782,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__48789){
var vec__48790 = p__48789;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48790,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48790,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__48799,existing_count){
var vec__48800 = p__48799;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48800,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48800,(1),null);
...
return cljs.core.filterv((function (p1__48794_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__48794_SHARP_))));
...
var vec__48808 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48808,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48808,(1),null);
var cvec_element = vec__48808;
if((cvec_element == null)){
var G__48851 = cljs.core.next(cvec_nl);
var G__48852 = (idx + (1));
var G__48853 = start;
var G__48854 = out;
cvec_nl = G__48851;
...
var G__48855 = cljs.core.next(cvec_nl);
var G__48856 = (idx + (1));
var G__48857 = idx;
var G__48858 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__48855;
idx = G__48856;
start = G__48857;
out = G__48858;
...
var G__48860 = cljs.core.next(cvec_nl);
var G__48861 = (idx + (1));
var G__48862 = (idx + (1));
var G__48863 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__48860;
idx = G__48861;
start = G__48862;
out = G__48863;
...
var G__48864 = cljs.core.next(cvec_nl);
var G__48865 = (idx + (1));
var G__48866 = idx;
...
var G__48868 = cljs.core.next(cvec_nl);
var G__48869 = (idx + (1));
var G__48870 = start;
var G__48871 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__48868;
idx = G__48869;
start = G__48870;
out = G__48871;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__48814_SHARP_,p2__48813_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__48813_SHARP_)){
return cljs.core.reduced(p1__48814_SHARP_);
} else {
return (p1__48814_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__48815,p__48816){
var vec__48817 = p__48815;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48817,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48817,(1),null);
var vec__48820 = p__48816;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48820,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48820,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__48826,cvec,focus_vec){
...
var map__48828 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48827__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48828__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48828__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48828__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48825_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__48825_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
