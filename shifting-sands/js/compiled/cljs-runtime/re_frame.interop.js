...
return [(function (){var pred__52284 = cljs.core.instance_QMARK_;
var expr__52285 = reactive_val;
if(cljs.core.truth_((pred__52284.cljs$core$IFn$_invoke$arity$2 ? pred__52284.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__52285) : pred__52284.call(null,reagent.ratom.RAtom,expr__52285)))){
return "ra";
} else {
if(cljs.core.truth_((pred__52284.cljs$core$IFn$_invoke$arity$2 ? pred__52284.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__52285) : pred__52284.call(null,reagent.ratom.RCursor,expr__52285)))){
return "rc";
} else {
if(cljs.core.truth_((pred__52284.cljs$core$IFn$_invoke$arity$2 ? pred__52284.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__52285) : pred__52284.call(null,reagent.ratom.Reaction,expr__52285)))){
return "rx";
} else {
if(cljs.core.truth_((pred__52284.cljs$core$IFn$_invoke$arity$2 ? pred__52284.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__52285) : pred__52284.call(null,reagent.ratom.Track,expr__52285)))){
return "tr";
} else {
return "other";
}
