...
var G__44999 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__44999;
continue;
} else {
return ch;
...
var vec__44977 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44977,(0),null);
return (match === s);
});
...
var len__4736__auto___45102 = arguments.length;
var i__4737__auto___45103 = (0);
while(true){
if((i__4737__auto___45103 < len__4736__auto___45102)){
args__4742__auto__.push((arguments[i__4737__auto___45103]));

var G__45104 = (i__4737__auto___45103 + (1));
i__4737__auto___45103 = G__45104;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq44987){
...
return (function() { 
var G__45105__delegate = function (rdr,_){
...
var G__45105 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__45106__i = 0, G__45106__a = new Array(arguments.length -  1);
while (G__45106__i < G__45106__a.length) {G__45106__a[G__45106__i] = arguments[G__45106__i + 1]; ++G__45106__i;}
  _ = new cljs.core.IndexedSeq(G__45106__a,0,null);
} 
return G__45105__delegate.call(this,rdr,_);};
G__45105.cljs$lang$maxFixedArity = 1;
G__45105.cljs$lang$applyTo = (function (arglist__45108){
var rdr = cljs.core.first(arglist__45108);
var _ = cljs.core.rest(arglist__45108);
return G__45105__delegate(rdr,_);
});
