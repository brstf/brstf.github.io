...
var temp__5733__auto____$1 = (o41710["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o41711 = temp__5733__auto____$1;
return (o41711["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__41307__auto__ = f;
return (o__41307__auto__["toString"]).call(o__41307__auto__);
} else {
return "";
}
}catch (e41712){var _ = e41712;
return "";
}});
...
try{var o__41307__auto___41914 = t;
(o__41307__auto___41914["cljs$lang$ctorPrWriter"]).call(o__41307__auto___41914,t,writer);
}catch (e41718){var __41915 = e41718;
}
...
var char_code = (function (){var o__41307__auto__ = (new String(char$));
return (o__41307__auto__["charCodeAt"]).call(o__41307__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__41307__auto__ = String;
return (o__41307__auto__["fromCharCode"]).call(o__41307__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__41732 = num_code;
switch (G__41732) {
case (1):
return (185);
...
var o__41307__auto__ = String;
return (o__41307__auto__["fromCharCode"]).call(o__41307__auto__,superscript_code);
});
/**
...
}catch (e41746){var _e__41331__auto__ = e41746;
return false;
}})())){
...
var vec__41747 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41747,(0),null);
...
var len__4736__auto___41958 = arguments.length;
var i__4737__auto___41959 = (0);
while(true){
if((i__4737__auto___41959 < len__4736__auto___41958)){
args__4742__auto__.push((arguments[i__4737__auto___41959]));

var G__41960 = (i__4737__auto___41959 + (1));
i__4737__auto___41959 = G__41960;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__41767){
var vec__41768 = p__41767;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41768,(0),null);
...
var G__41966 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__41967 = cljs.core.butlast(remaining_tokens);
name_tokens = G__41966;
remaining_tokens = G__41967;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq41760){
var G__41761 = cljs.core.first(seq41760);
var seq41760__$1 = cljs.core.next(seq41760);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41761,seq41760__$1);
}));
...
var vec__41783 = cljs.core.split_with((function (p1__41782_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__41782_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41783,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41783,(1),null);
...
var vec__41790 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41790,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41790,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__41978 = cljs.core.rest(remaining_tokens);
var G__41979 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__41978;
name_tokens = G__41979;
continue;
} else {
...
var vec__41798 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41798,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41798,(1),null);
var vec__41801 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41801,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41801,(1),null);
var vec__41804 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41804,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41804,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41804,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41804,(3),null);
...
var vec__41813 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41813,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41813,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41813,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41813,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41813,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41813,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__41816 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41816,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41816,(1),null);
var vec__41819 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41819,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41819,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__41822 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__41822) : devtools.munging.parse_fn_info_deep.call(null,G__41822));
})()));
}
} else {
return fn_info;
...
var G__42016 = (arity + (1));
var G__42017 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__41824){
var vec__41825 = p__41824;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41825,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41825,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41830_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__41830_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41831_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__41831_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___42041 = arguments.length;
var i__4737__auto___42042 = (0);
while(true){
if((i__4737__auto___42042 < len__4736__auto___42041)){
args__4742__auto__.push((arguments[i__4737__auto___42042]));

var G__42043 = (i__4737__auto___42042 + (1));
i__4737__auto___42042 = G__42043;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__41834){
var vec__41835 = p__41834;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41835,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq41832){
var G__41833 = cljs.core.first(seq41832);
var seq41832__$1 = cljs.core.next(seq41832);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41833,seq41832__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41853__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41853__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41853__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41853__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__41854 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41854,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41854,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41854,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41854,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41854,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41854,(5),null);
...
var o__41307__auto__ = f;
return (o__41307__auto__["getBasis"]).call(o__41307__auto__);
});
/**
...
}catch (e41872){var _e__41331__auto__ = e41872;
...
var G__42064 = (obj[cljs.core.first(path)]);
var G__42065 = cljs.core.rest(path);
obj = G__42064;
path = G__42065;
continue;
} else {
...
var _STAR_ = (function (accum,p__41885){
var vec__41886 = p__41885;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41886,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41886,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__41894){
var vec__41895 = p__41894;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41895,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41895,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41895,(2),null);
...
var post_process = (function (p__41902){
var vec__41903 = p__41902;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41903,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41903,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41900_SHARP_){
return (obj[cljs.core.first(p1__41900_SHARP_)]);
}),sorted_matches);
